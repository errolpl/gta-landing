		...
		<section className="lucia-life">
			...
			<div className="lg:w-1/2 lucia-life-content">
				<div className="max-w-xl lg:ps-32 ps-10">
					...
					<p>
						Life has been coming at her swinging ever since. Fighting for her family landed her in the Leonida Penitentiary. Sheer luck got her out. Lucia&apos;s learned her lesson — only smart moves
						from here.
					</p>
				</div>
				...
				<p className="max-w-xl lg:ps-32 ps-10">
					More than anything, Lucia wants the good life her mom has dreamed of since their days in Liberty City — but instead of half-baked fantasies, Lucia is prepared to take matters into her own
					hands.
				</p>
			</div>
		</section>
